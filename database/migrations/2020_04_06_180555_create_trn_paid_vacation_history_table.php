...
class CreateTrnPaidVacationHistoryTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('trn_paid_vacation_history', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('trn_paid_vacation_history');
    }
}
